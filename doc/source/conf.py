...
version = None
for line in open(os.path.join(root_path, 'autoplanner', '__init__.py'), 'r', encoding='utf-8'):
...
htmlhelp_basename = 'AutoPlanner doc'
...
latex_documents = [
    ('index', 'autoplanner.tex', 'AutoPlanner\'s Documentation',
     author, 'manual'),
]
...
man_pages = [
    ('index', 'autoplanner', 'AutoPlanner\'s documentation',
     [author], 1)
]
